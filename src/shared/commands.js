...
export const CATEGORIES = [
  {
    ...
    cmds: [
      { name: 'Mapear Soft (S:)',        desc: 'net use S: \\\\sjkfs13.sjk.emb\\soft',         type: 'script', cmd: 'SCRIPT_MAPEAR_SOFT',       tip: 'Mapeia S: pedindo usuario e senha TI' },
      ...
      { name: 'Remover perfil EMB_CORP', desc: 'netsh wlan delete profile EMB_CORP',            type: 'cmd',    cmd: 'netsh wlan delete profile name="EMB_CORP"', tip: 'Remove perfil WiFi - resolve erros de certificado na reconexao' },
  ...
  },
  {
    id: 'instalacoes',
    name: 'Instalacoes',
    sub: 'softwares base Embraer / rollout',
    cmds: [
      { name: 'Office 365 (Notebook)',   desc: 'EasyDeploy\\IGOR\\OfficeSetup.exe',             type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\SOFT\\Utilitarios\\EasyDeploy\\IGOR\\OfficeSetup.exe', tip: 'Notebooks NB00000S - Office 365 atualizado' },
      { name: 'Office 2016 (Desktop)',   desc: 'Office2016_PRO.xml x64',                        type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\SOFT\\Licenciados\\Midias Download\\Microsoft Office\\2016\\PRO\\PT-BR\\x64\\setup.exe /config \\\\sjkfs13.sjk.emb\\soft\\Utilitarios\\EasyDeploy\\SoftwaresBasicos\\Office2016_PRO.xml', tip: 'Desktops / mini PCs - Office 2016 Pro' },
      { name: 'Adobe Acrobat Reader',    desc: 'AcroRead.msi /q',                               type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\SOFT\\Utilitarios\\Adobe\\Acrobat Reader DC\\Binaries\\AcroRead.msi /q', tip: 'Leitor de PDF - obrigatorio em todas as maquinas' },
      { name: 'Google Chrome',           desc: 'ChromeSetup.exe /silent',                       type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\soft\\Utilitarios\\EasyDeploy\\SoftwaresBasicos\\ChromeSetup.exe /silent /install', tip: 'Navegador padrao' },
      { name: 'Microsoft Teams',         desc: 'MSTeamsSetup.exe',                              type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\SOFT\\Utilitarios\\EasyDeploy\\IGOR\\MSTeamsSetup.exe', tip: 'Teams corrigido via EasyDeploy IGOR' },
      { name: 'Splashtop Streamer',      desc: 'Install.cmd Splashtop 3.8.0.4',                 type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\soft\\Utilitarios\\Splashtop\\Streamer 3.8.0.4\\Brazil Endpoints\\Install.cmd', tip: 'Acesso remoto - obrigatorio em todas as maquinas' },
      { name: 'PDF Creator',             desc: 'PDFCreator-4_4_3 /silent',                      type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\soft\\Utilitarios\\Pdf Creator\\PDFCreator-4_4_3-Setup.exe /silent', tip: 'Impressora virtual PDF' },
      { name: 'Greenshot',               desc: 'Install.cmd Greenshot 1.3.315',                 type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\soft\\Utilitarios\\Greenshot\\1.3.315\\Install.cmd', tip: 'Ferramenta de captura de tela' },
      { name: 'Notepad++',               desc: 'npp.7.7 x64 /S',                               type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\pacotes$\\Notepad++\\7.7\\x64\\npp.7.7.Installer.x64.exe /S', tip: 'Editor de texto avancado' },
      { name: 'Firefox ESR',             desc: 'Firefox 102.7.0esr /qn',                        type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\soft\\Internet\\Firefox\\102.7.0\\Firefox Setup 102.7.0esr.msi /qn', tip: 'Navegador Firefox' },
      { name: 'Power BI Desktop',        desc: 'PBIDesktopSetup_x64.exe',                       type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\soft\\Utilitarios\\PowerBI Desktop\\2.153.1206.0\\Installer\\PBIDesktopSetup_x64.exe -quiet -norestart ACCEPT_EULA=1', tip: 'Power BI - instalar somente se solicitado' },
      { name: 'Citrix Workspace',        desc: 'Install.cmd Citrix 25.8.0.71',                  type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\SOFT\\Utilitarios\\Citrix\\Citrix Workspace\\25.8.0.71\\Install.cmd', tip: 'Necessario para acesso a sistemas legados' },
      { name: 'SAP Correcao',            desc: 'SAPSLTESP00 /silent',                           type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\SOFT\\Sistemas\\SAP\\Client 7.40\\SAP_Text_Editor\\SAPSLTESP00_0-70001053.EXE /silent', tip: 'Correcao obrigatoria do SAP' },
      { name: 'FlexNet Inventory',       desc: 'Install.cmd FlexNET',                           type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\pacotes$\\FlexNET\\Flexnet Inventory Agent_21\\Package\\Install.cmd', tip: 'Agente de inventario de licencas' },
      { name: 'EasyInventory',           desc: 'Easy2WSetup /key:E7F6-13780',                   type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\SOFT\\EasyInventory\\1.0.18\\Easy2WSetup.exe /key:E7F6-13780 /verysilent', tip: 'Sistema de inventario de ativos' },
      { name: 'CATIA Composer Player',   desc: 'EMBISD_Installer.exe (opcional)',                type: 'open',   cmd: '\\\\nfscad05\\dmuv5\\applications\\Install\\ComposerPlayer_R2026\\EMBISD_Installer.exe', tip: 'OPCIONAL - requer GBI instalado antes' },
      { name: 'GBI (pre-req CATIA)',     desc: 'GBI.bat - pre-requisito',                       type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\SOFT\\Utilitarios\\EasyDeploy\\SoftwaresProjeto\\GBI\\GBI.bat', tip: 'Instalar ANTES do CATIA Composer Player' },
      { name: 'Abrir pasta Soft',        desc: 'explorer \\\\sjkfs13.sjk.emb\\soft',            type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\soft', tip: 'Abre compartilhamento de software' },
    ]
  },
  {
    id: 'scripts',
    ...
    cmds: [
      ...
      { name: 'Remover SCCM',           desc: 'sccm_uninstall.bat',                            type: 'open',   cmd: '\\\\sjkfs13.sjk.emb\\soft\\Utilitarios\\EasyDeploy\\SoftwaresBasicos\\sccm_uninstall.bat', tip: 'Remove SCCM - executar durante rollout' },
    ]
  },
  {
    id: 'drivers',
