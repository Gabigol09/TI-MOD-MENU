...
export const CATEGORIES = [
  {
    ...
    cmds: [
      ...
      { name: 'IP Config completo',       desc: 'ipconfig /all',                                 type: 'cmd',    commandId: 'rede.ipconfig-all',   cmd: 'ipconfig /all',             tip: 'Exibe todos adaptadores, IPs, MAC e DNS' },
      { name: 'Flush DNS',               desc: 'ipconfig /flushdns',                            type: 'cmd',    commandId: 'rede.flush-dns',      cmd: 'ipconfig /flushdns',        tip: 'Limpa cache DNS - resolve sites e pastas que param de abrir' },
      { name: 'Ping gateway',            desc: 'ping 192.168.1.1 -t',                           type: 'cmd',    cmd: 'ping 192.168.1.1 -t',       tip: 'Testa conectividade continua com o gateway' },
      { name: 'Ver mapeamentos',         desc: 'net use',                                       type: 'cmd',    commandId: 'rede.list-mappings',  cmd: 'net use',                   tip: 'Lista todas as unidades de rede mapeadas' },
  ...
  },
  {
    ...
    cmds: [
      { name: 'Nome do PC (Hostname)',   desc: 'hostname',                                      type: 'cmd',    commandId: 'diagnostico.hostname', cmd: 'hostname',                  tip: 'Exibe o nome atual do computador na rede' },
      ...
      { name: 'Info geral sistema',     desc: 'systeminfo',                                    type: 'cmd',    commandId: 'diagnostico.systeminfo', cmd: 'systeminfo',                tip: 'SO, RAM, dominio, hotfixes e mais' },
