...
export const CATEGORIES = [
  ...
  },
  {
    ...
    cmds: [
      { name: 'Office 365 (Notebook)',   desc: 'OfficeSetup.exe',                               type: 'open',   cmd: '\\\\servidor\\soft\\Utilitarios\\EasyDeploy\\OfficeSetup.exe', tip: 'Notebooks - Office 365 atualizado (caminho definido no config.json)' },
      { name: 'Office 2016 (Desktop)',   desc: 'Office2016_PRO.xml x64',                        type: 'open',   cmd: '\\\\servidor\\soft\\Licenciados\\Microsoft Office\\2016\\PRO\\PT-BR\\x64\\setup.exe /config \\\\servidor\\soft\\Utilitarios\\EasyDeploy\\SoftwaresBasicos\\Office2016_PRO.xml', tip: 'Desktops / mini PCs - Office 2016 Pro' },
      { name: 'Adobe Acrobat Reader',    desc: 'AcroRead.msi /q',                               type: 'open',   cmd: '\\\\servidor\\soft\\Utilitarios\\Adobe\\Acrobat Reader DC\\Binaries\\AcroRead.msi /q', tip: 'Leitor de PDF - obrigatorio em todas as maquinas' },
      { name: 'Google Chrome',           desc: 'ChromeSetup.exe /silent',                       type: 'open',   cmd: '\\\\servidor\\soft\\Utilitarios\\EasyDeploy\\SoftwaresBasicos\\ChromeSetup.exe /silent /install', tip: 'Navegador padrao' },
      { name: 'Microsoft Teams',         desc: 'MSTeamsSetup.exe',                              type: 'open',   cmd: '\\\\servidor\\soft\\Utilitarios\\EasyDeploy\\MSTeamsSetup.exe', tip: 'Instalador do Teams' },
      { name: 'PDF Creator',             desc: 'PDFCreator-4_4_3 /silent',                      type: 'open',   cmd: '\\\\servidor\\soft\\Utilitarios\\Pdf Creator\\PDFCreator-4_4_3-Setup.exe /silent', tip: 'Impressora virtual PDF' },
      { name: 'Greenshot',               desc: 'Install.cmd Greenshot 1.3.315',                 type: 'open',   cmd: '\\\\servidor\\soft\\Utilitarios\\Greenshot\\1.3.315\\Install.cmd', tip: 'Ferramenta de captura de tela' },
      { name: 'Notepad++',               desc: 'npp.7.7 x64 /S',                               type: 'open',   cmd: '\\\\servidor\\pacotes$\\Notepad++\\7.7\\x64\\npp.7.7.Installer.x64.exe /S', tip: 'Editor de texto avancado' },
      { name: 'Firefox ESR',             desc: 'Firefox 102.7.0esr /qn',                        type: 'open',   cmd: '\\\\servidor\\soft\\Internet\\Firefox\\102.7.0\\Firefox Setup 102.7.0esr.msi /qn', tip: 'Navegador Firefox' },
      { name: 'Power BI Desktop',        desc: 'PBIDesktopSetup_x64.exe',                       type: 'open',   cmd: '\\\\servidor\\soft\\Utilitarios\\PowerBI Desktop\\2.153.1206.0\\Installer\\PBIDesktopSetup_x64.exe -quiet -norestart ACCEPT_EULA=1', tip: 'Power BI - instalar somente se solicitado' },
      { name: 'Abrir pasta Soft',        desc: 'explorer \\\\servidor\\soft',                   type: 'open',   cmd: '\\\\servidor\\soft', tip: 'Abre compartilhamento de software - caminho definido no config.json' },
    ]
  },
  {
    id: 'scripts',
