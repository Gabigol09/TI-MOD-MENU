...
export const CATEGORIES = [
  ...
  },
  {
    ...
    cmds: [
      { name: 'Office 365 (Notebook)',   desc: 'OfficeSetup.exe',                               type: 'open',   cmd: '\\\\servidor\\soft\\Utilitarios\\DeployTools\\OfficeSetup.exe', tip: 'Notebooks - Office 365 atualizado (caminho definido no config.json)' },
      { name: 'Office 2016 (Desktop)',   desc: 'Office2016_PRO.xml x64',                        type: 'open',   cmd: '\\\\servidor\\soft\\Licenciados\\Microsoft Office\\2016\\PRO\\PT-BR\\x64\\setup.exe /config \\\\servidor\\soft\\Utilitarios\\DeployTools\\SoftwaresBasicos\\Office2016_PRO.xml', tip: 'Desktops / mini PCs - Office 2016 Pro' },
      ...
      { name: 'Google Chrome',           desc: 'ChromeSetup.exe /silent',                       type: 'open',   cmd: '\\\\servidor\\soft\\Utilitarios\\DeployTools\\SoftwaresBasicos\\ChromeSetup.exe /silent /install', tip: 'Navegador padrao' },
      { name: 'Microsoft Teams',         desc: 'MSTeamsSetup.exe',                              type: 'open',   cmd: '\\\\servidor\\soft\\Utilitarios\\DeployTools\\MSTeamsSetup.exe', tip: 'Instalador do Teams' },
